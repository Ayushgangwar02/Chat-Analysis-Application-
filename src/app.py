...
st.sidebar.markdown('<b>Ayush Gangwar</b>\
                <a href = "https://github.com/Ayushgangwar02/Chat-Analysis-Application-" ><img src = "https://img.shields.io/badge/Author-@Ayushgangwar-gray.svg?colorA=gray&colorB=dodgerblue&logo=github"/>\
...
st.sidebar.markdown(
    "[![built with love](https://forthebadge.com/images/badges/built-with-love.svg)](https://www.linkedin.com/in/ayush-gangwar-3babb9250/)")
st.sidebar.markdown(
    "[![smile please](https://forthebadge.com/images/badges/makes-people-smile.svg)](https://www.linkedin.com/in/ayush-gangwar-3babb9250/)")
